...
<main class="container">
    ...
    <form method="POST" action="cargarMedico" style="width: 90vh">
        ...
        <div>
            ...
            <button id="btn-agregar-medico" class="btn-agregar rounded " type ="submit">Guardar</button> <a href="mostrarPersonal"><button id="btn-agregar-medico" class="btn-agregar rounded">Cancelar</button></a>
